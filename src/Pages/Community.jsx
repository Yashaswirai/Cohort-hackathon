  ...
  const Blogs = [
    {
      ...
      image: "https://www.rosierfoods.com/cdn/shop/articles/WhatsApp_Image_2023-07-09_at_12.18.57_PM.jpg?v=1712256951",
      link: "/blog/1",
    },
    {
      name: "Keeping Your Heart Healthy: Tips for a Stronger Heart",
      image: "https://www.rosierfoods.com/cdn/shop/articles/Untitled_design_38.png?v=1712256458",
      link: "/blog/2",
    },
    {
      name: "Raw Honey for Immunity: Health Benefits",
      image: "https://www.rosierfoods.com/cdn/shop/articles/close-up-honeycomb-with-beeswax.jpg?v=1712255863",
      link: "/blog/3",
    },
    {
      name: "Mindful Munching: The Art of Eating with Awareness",
      image: "https://www.rosierfoods.com/cdn/shop/articles/Untitled_design-26.png?v=1749659476",
      link: "/blog/4",
    },
    {
      name: "Summer Approaches: Strategies to Adapt to the Weather",
      image: "https://www.rosierfoods.com/cdn/shop/articles/pexels-A_nil-1391249.jpg?v=1712255095&width=720",
      link: "/blog/5",
    },
    {
      name: "All You Need to Know About Going Organic",
      image: "https://www.rosierfoods.com/cdn/shop/articles/woman-spreading-soft-cheese-toasted-bread.jpg?v=1712253591",
      link: "/blog/6",
    },
  ]
  return (
    <div className="w-full min-h-screen bg-black text-amber-500 py-15">
      <div className="blog w-full px-4 py-5 flex flex-col items-center">
        <h2 className="text-2xl font-semibold mb-4">Blog Section</h2>
